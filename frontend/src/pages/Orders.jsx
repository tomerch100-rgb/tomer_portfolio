...
function Orders() {
    ...
    const onSubmit = async (data) => {
        ...
        console.log("הנתונים שנשלחו בהצלחה:", formattedData);
        try {
            let response;
            if (orderType === "buy") {
            ...
            console.error("לא הצלחנו לבצע את הפעולה ");
        } finally {
        ...
        <div className="w-full max-w-md mx-auto p-8 bg-[#121214] border border-zinc-800 rounded-3xl shadow-2xl font-sans">
            ...
            <div className="flex gap-4 mb-8">
                <button
                    ...
                    className={`flex-1 py-3 px-4 rounded-xl font-semibold text-sm transition-all duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-[#121214] focus:ring-green-500 ${
                        orderType === "buy"
                ...
                <button
                    ...
                    className={`flex-1 py-3 px-4 rounded-xl font-semibold text-sm transition-all duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-[#121214] focus:ring-red-500 ${
                        orderType === "sell"
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
                ...
                <div className="space-y-1.5">
                    ...
                    <input
                        ...
                        className={`w-full px-4 py-3 bg-zinc-900/50 border rounded-xl text-zinc-100 placeholder-zinc-600 focus:outline-none transition-all duration-200 ${
                            orderType === "buy" 
                ...
                <div className="space-y-1.5">
                    ...
                    <div className="relative">
                        ...
                        <input
                            ...
                            step="any"
                            placeholder="0.00"
                            className={`w-full pl-8 pr-4 py-3 bg-zinc-900/50 border rounded-xl text-zinc-100 placeholder-zinc-600 focus:outline-none transition-all duration-200 ${
                                orderType === "buy" 
                                    ? "focus:border-green-500 focus:ring-1 focus:ring-green-500" 
                                    : "focus:border-red-500 focus:ring-1 focus:ring-red-500"
                ...
                <button
                    ...
                    className={`w-full mt-8 py-3.5 rounded-xl font-bold text-sm tracking-wide transition-all duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-[#121214] active:scale-[0.98] ${
                        orderType === "buy"
