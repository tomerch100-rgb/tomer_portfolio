...
@pytest.mark.asyncio
async def test_add_watchlist_item_success(client: AsyncClient, auth_headers: dict, test_user: User, db_session: Session):
...
@pytest.mark.asyncio
async def test_update_watchlist_alert_target(client: AsyncClient, auth_headers: dict, test_user: User, db_session: Session):
